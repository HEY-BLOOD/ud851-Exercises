...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<String> {
    ...
    private void makeGithubSearchQuery() {
        ...
        githubBundle.putString(SEARCH_QUERY_URL_EXTRA, githubSearchUrl.toString());
        ...
        if (githubSearchLoader == null) {
            githubSearchLoader = loaderManager.initLoader(GITHUB_SEARCH_LOADER, githubBundle, this);
        } else {
            githubSearchLoader = loaderManager.restartLoader(GITHUB_SEARCH_LOADER, githubBundle, this);
        }
    }
